...
set_property -dict {PACKAGE_PIN N3 IOSTANDARD LVCMOS33} [get_ports {V1_V2_TX[0]}]
#set_property -dict {PACKAGE_PIN P3 IOSTANDARD LVCMOS33} [get_ports {V1_V2_RX[0]}] pio[19]
#set_property -dict {PACKAGE_PIN M2 IOSTANDARD LVCMOS33} [get_ports {V1_V2_TX[1]}] pio[18]
set_property -dict {PACKAGE_PIN N1 IOSTANDARD LVCMOS33} [get_ports {V1_V2_RX[1]}]
...
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports sw[0]]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports {sw[1]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports {sw[2]}]
...
## Pmod Header JA
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { Tx_Rx_switch }]; # em_rec debug -> JA[7]
#set_property -dict { PACKAGE_PIN H19   IOSTANDARD LVCMOS33 } [get_ports { Cswitch_Rx }]; #IO_L4P_T0_D04_14 Sch=ja[8]
set_property PACKAGE_PIN J19 [get_ports em_rec_real_in]
set_property IOSTANDARD LVCMOS33 [get_ports em_rec_real_in]
set_property PULLTYPE PULLDOWN [get_ports em_rec_real_in]
...
#set_property PACKAGE_PIN G3 [get_ports { vauxp4 }]  ; # ain_p[15]
#set_property PACKAGE_PIN G2 [get_ports { vauxn4 }]  ; # ain_n[15]
...
#set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { V1_V2[0]  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
#set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { V1_V2[1]  }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
#set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { pio[2]  }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
#set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { pio3  }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pio4  }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
#set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { pio5  }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { pio6  }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
...
#set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { pio[10] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]
#set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { pio[11] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]
#set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { pio[12] }]; #IO_L6N_T0_VREF_35 Sch=pio[13]
#set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { pio[13] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]
#set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { pio[14] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]
...
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp6]
set_property PULLTYPE PULLDOWN [get_ports Vcomp6]
set_property PACKAGE_PIN R2 [get_ports Vcomp5]
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp5]
set_property PULLTYPE PULLDOWN [get_ports Vcomp5]
set_property PACKAGE_PIN T1 [get_ports Vcomp4]
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp4]
set_property PULLTYPE PULLDOWN [get_ports Vcomp4]
set_property PACKAGE_PIN T2 [get_ports Vcomp3]
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp3]
set_property PULLTYPE PULLDOWN [get_ports Vcomp3]
set_property PACKAGE_PIN U1 [get_ports Vcomp2]
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp2]
set_property PULLTYPE PULLDOWN [get_ports Vcomp2]
set_property PACKAGE_PIN W2 [get_ports Vcomp1]
set_property IOSTANDARD LVCMOS33 [get_ports Vcomp1]
set_property PULLTYPE PULLDOWN [get_ports Vcomp1]
#set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports { pio[22] }]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
#set_property -dict { PACKAGE_PIN U5    IOSTANDARD LVCMOS33 } [get_ports { pio[23] }]; #IO_L16P_T2_34 Sch=pio[41]
#set_property -dict { PACKAGE_PIN U2    IOSTANDARD LVCMOS33 } [get_ports { pio[24] }]; #IO_L9N_T1_DQS_34 Sch=pio[42]
#set_property -dict { PACKAGE_PIN W6    IOSTANDARD LVCMOS33 } [get_ports { pio[25] }]; #IO_L13N_T2_MRCC_34 Sch=pio[43]
set_property -dict { PACKAGE_PIN U3    IOSTANDARD LVCMOS33 } [get_ports { V1_V2_TX[1] }]; #IO_L9P_T1_DQS_34 Sch=pio[44]
