# 0 "/home/yousef/Vivado_workspace/AH_CMOD_35t/Soft/platform_35t/hw/sdt/system-top.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/yousef/Vivado_workspace/AH_CMOD_35t/Soft/platform_35t/hw/sdt/system-top.dts"
/dts-v1/;
# 1 "/home/yousef/Vivado_workspace/AH_CMOD_35t/Soft/platform_35t/hw/sdt/pl.dtsi" 1
/ {
 ...
 amba_pl: amba_pl {
  ...
  axi_dma_0: dma@41e00000 {
   ...
   clock-frequency = <100000000 100000000>;
  ...
  axi_gpio_3: gpio@40040000 {
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_3";
   xlnx,all-inputs = <0>;
  };
  axi_gpio_4: gpio@40050000 {
   #interrupt-cells = <2>;
   interrupts = < 2 2 >;
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   ...
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_4";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_5: gpio@40060000 {
   #interrupt-cells = <2>;
   interrupts = < 3 2 >;
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   ...
   interrupt-names = "ip2intc_irpt";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_5";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_6: gpio@40070000 {
   #interrupt-cells = <2>;
   interrupts = < 4 2 >;
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   ...
   interrupt-names = "ip2intc_irpt";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_6";
   xlnx,all-inputs = <1>;
  };
  axi_gpio_7: gpio@40080000 {
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
   xlnx,all-outputs = <1>;
   #gpio-cells = <2>;
   ...
   clock-names = "s_axi_aclk";
   xlnx,tri-default = <0xffffffff>;
   xlnx,name = "axi_gpio_7";
   xlnx,all-inputs = <0>;
  };
  axi_gpio_irq_spi: gpio@40030000 {
   #interrupt-cells = <2>;
   interrupts = < 1 2 >;
   xlnx,gpio-board-interface = "Custom";
   compatible = "xlnx,axi-gpio-2.0" , "xlnx,xps-gpio-1.00.a";
  ...
  xadc_wiz_0: xadc_wiz@44a00000 {
   ...
   xlnx,configuration-r0 = <276>;
   xlnx,has-drp = <0>;
   xlnx,vaux4 = <1>;
   xlnx,sim-file-rel-path = "./";
   reg = <0x44a00000 0x10000>;
   xlnx,alarm-limit-r8 = <22937>;
   xlnx,configuration-r1 = <12704>;
   ...
   xlnx,vaux10 = <0>;
   xlnx,has-vn = <1>;
   xlnx,has-vccpaux-alarm = <0>;
   xlnx,acquisition-time = <10>;
   xlnx,vaux11 = <0>;
   xlnx,has-temp-bus = <0>;
   ...
   xlnx,vccaux-alarm;
   xlnx,sampling-rate = <0x000000df 0xe0288f62>;
   xlnx,has-reset = <0>;
   xlnx,adc-conversion-rate = <1000>;
   clock-frequency = <100000000>;
   xlnx,vccddro-alarm-lower = <0x118c30>;
   xlnx,enable-calibration-averaging;
   xlnx,has-user-temp-alarm = <1>;
   xlnx,enable-axi4stream;
   xlnx,has-ot-alarm = <1>;
   xlnx,has-convst = <0>;
   xlnx,single-channel-selection = "VAUXP4_VAUXN4";
...
# 3 "/home/yousef/Vivado_workspace/AH_CMOD_35t/Soft/platform_35t/hw/sdt/system-top.dts" 2
/ {
 board = "cmod_a7-35t";
 ...
 cpus_microblaze_0: cpus_microblaze@0 {
  address-map = <0xC0000000 &axi_bram_ctrl_0_memory 0xC0000000 0x2000>,
         ...
         <0x40030000 &axi_gpio_irq_spi 0x40030000 0x10000>,
         <0x40040000 &axi_gpio_3 0x40040000 0x10000>,
         <0x40050000 &axi_gpio_4 0x40050000 0x10000>,
         <0x40060000 &axi_gpio_5 0x40060000 0x10000>,
         <0x40070000 &axi_gpio_6 0x40070000 0x10000>,
         <0x40080000 &axi_gpio_7 0x40080000 0x10000>,
         ...
         <0x44a00000 &xadc_wiz_0 0x44a00000 0x10000>;
