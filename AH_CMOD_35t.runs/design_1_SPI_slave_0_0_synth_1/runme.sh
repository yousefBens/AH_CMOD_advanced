...
HD_PWD='/home/yousef/Vivado_workspace/AH_CMOD_35t/AH_CMOD_35t.runs/design_1_SPI_slave_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SPI_slave_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SPI_slave_0_0.tcl
