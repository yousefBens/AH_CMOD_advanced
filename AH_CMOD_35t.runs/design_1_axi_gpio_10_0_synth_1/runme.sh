...
HD_PWD='/home/yousef/Vivado_workspace/AH_CMOD_35t/AH_CMOD_35t.runs/design_1_axi_gpio_10_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_gpio_10_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_gpio_10_0.tcl
