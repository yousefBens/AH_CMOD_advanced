...
(* CHECK_LICENSE_TYPE = "design_1_SPI_slave_0_0,SPI_slave,{}" *) (* core_generation_info = "design_1_SPI_slave_0_0,SPI_slave,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=SPI_slave,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,data_length=16}" *) (* downgradeipidentifiedwarnings = "yes" *) 
