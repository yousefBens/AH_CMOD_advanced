...
-- Date        : Wed Mar 18 15:17:37 2026
-- Host        : Yousef-Machine running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/yousef/Vivado_workspace/AH_CMOD_35t/AH_CMOD_35t.gen/sources_1/bd/design_1/ip/design_1_EM_REC_Delay_Duty_Mo_2_0/design_1_EM_REC_Delay_Duty_Mo_2_0_sim_netlist.vhdl
...
entity design_1_EM_REC_Delay_Duty_Mo_2_0_EM_REC_Delay_Duty_Mode_QPF is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_EM_REC_Delay_Duty_Mo_2_0_EM_REC_Delay_Duty_Mode_QPF : entity is "EM_REC_Delay_Duty_Mode_QPF";
end design_1_EM_REC_Delay_Duty_Mo_2_0_EM_REC_Delay_Duty_Mode_QPF;

architecture STRUCTURE of design_1_EM_REC_Delay_Duty_Mo_2_0_EM_REC_Delay_Duty_Mode_QPF is
  signal delay_active0 : STD_LOGIC;
  signal delay_active8_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of delay_active_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of delay_active_i_4 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \delay_cnt[0]_i_4\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of pulse_active_i_3 : label is "soft_lutpair1";
...
delay_active_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\delay_cnt[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      ...
      I1 => delay_active_i_2_n_0,
      I2 => \delay_cnt1_carry__0_n_2\,
      O => \delay_cnt[0]_i_2_n_0\
    );
\delay_cnt[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"0000FFEF"
    )
        port map (
      I0 => delay_active_i_8_n_0,
      I1 => delay_active_i_7_n_0,
      I2 => delay_active_i_6_n_0,
      I3 => delay_active_i_5_n_0,
...
out_sig_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFF45"
    )
        port map (
      ...
      I2 => pulse_active,
      I3 => out_sig_i_3_n_0,
      I4 => delay_active8_out,
      O => out_sig_i_2_n_0
    );
out_sig_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
out_sig_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
pulse_active_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => em_sync1,
      I5 => delay_active_i_2_n_0,
      O => pulse_active_i_2_n_0
    );
pulse_active_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"CCCE"
    )
        port map (
      I0 => em_sync1,
      I1 => delay_active_reg_n_0,
      I2 => \^em_sync2_reg_0\,
      I3 => pulse_active,
...
entity design_1_EM_REC_Delay_Duty_Mo_2_0 is
  ...
  attribute NotValidForBitStream of design_1_EM_REC_Delay_Duty_Mo_2_0 : entity is true;
  ...
  attribute x_core_info of design_1_EM_REC_Delay_Duty_Mo_2_0 : entity is "EM_REC_Delay_Duty_Mode_QPF,Vivado 2025.1";
end design_1_EM_REC_Delay_Duty_Mo_2_0;

architecture STRUCTURE of design_1_EM_REC_Delay_Duty_Mo_2_0 is
...
begin
U0: entity work.design_1_EM_REC_Delay_Duty_Mo_2_0_EM_REC_Delay_Duty_Mode_QPF
     port map (
      EM_REC => EM_REC,
      clk => clk,
